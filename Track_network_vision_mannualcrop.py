...
with tf.Session() as sess:
    ...
    for num_img in range(0,100):
        ...
        print 'height', rand_search_region.shape[0], 'width', rand_search_region.shape[1]
        bbox_estimate.unscale(rand_search_region)
        ...
        # img_out_curr_unscale = cv2.rectangle(rand_search_region,(bbox_output_unscale[0],bbox_output_unscale[1]),(bbox_output_unscale[2],bbox_output_unscale[3]),(0,255,0),1)
        # cv2.imwrite('./output/image_output/image_unscale_pre_cur'+format(num_img, '03d')+'.jpg', img_out_curr_unscale)
        #
        # print 'rand_search_location.x1', rand_search_location.x1, 'rand_search_location.y1', rand_search_location.y1
        # print 'edge_spacing_x',edge_spacing_x,' edge_spacing_y',edge_spacing_y
        bbox_estimate.uncenter(image, rand_search_location, edge_spacing_x, edge_spacing_y)
        ...
        img_out_curr = cv2.rectangle(image,(bbox_output[0],bbox_output[1]),(bbox_output[2],bbox_output[3]),(0,255,0),1)
